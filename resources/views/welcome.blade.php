...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                    <h2 class="text-center"><b>DATA PAJAK</b></h2>
                    ...
                    <button class="btn btn-primary" onclick="window.location.href = 'pajak.xlsx' "><i class="fa fa-download"></i> Download Template</button>
                    <hr>
                    <div class="row">
                      <div class="col-5">
